...
import 'widgets/date_navigator_widget.dart'; // Widget para navegación de fechas
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              child: Center(
                child: Text(
                  // Ejemplo de uso de la fecha seleccionada en HistorialScreen
                    'Aquí irán las notas del día: ${DateFormat('dd/MM/yyyy', 'es_ES').format(_selectedDate)}',
